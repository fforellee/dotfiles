...
if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=16 ctermfg=231 cterm=NONE guibg=#090909 guifg=#ffffff gui=NONE
    set background=dark
    hi NonText ctermbg=bg ctermfg=88 cterm=NONE guibg=bg guifg=#870000 gui=NONE
    hi Comment ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi Ignore ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi Statement ctermbg=bg ctermfg=166 cterm=NONE guibg=bg guifg=#D61C1C gui=NONE
    ...
    hi TabLine ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi qfLineNr ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi Visual ctermbg=215 ctermfg=16 cterm=NONE guibg=#ffaf5f guifg=#090909 gui=NONE
    ...
    hi Folded ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi IncSearch ctermbg=166 ctermfg=16 cterm=NONE guibg=#D61C1C guifg=#090909 gui=NONE
    hi Search ctermbg=180 ctermfg=16 cterm=NONE guibg=#d7af87 guifg=#090909 gui=NONE
    hi! link QuickFixLine Search
    hi Directory ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
    hi MatchParen ctermbg=95 ctermfg=221 cterm=bold guibg=#EFB0E0 guifg=#ffd75f gui=bold
    ...
    hi Cursor ctermbg=166 ctermfg=16 cterm=NONE guibg=#D61C1C guifg=#090909 gui=NONE
    ...
    hi markdownLinkDelimiter ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    hi markdownUrl ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    ...
    hi CtrlPLinePre ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    hi CtrlPPrtBase ctermbg=bg ctermfg=95 cterm=NONE guibg=bg guifg=#EFB0E0 gui=NONE
    hi CtrlPPrtText ctermbg=bg ctermfg=231 cterm=NONE guibg=bg guifg=#ffffff gui=NONE
    hi CtrlPPtrCursor ctermbg=bg ctermfg=166 cterm=NONE guibg=bg guifg=#D61C1C gui=NONE
